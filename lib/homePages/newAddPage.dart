...
class Creation {
  ...
  Creation(this.title, this.subtitle,this.image);
}
...
class _NewAddPageState extends State<NewAddPage> {
  ...
  List<Creation> creationList = [
    Creation('finger tattoos', 'with inkbox','images/cardImages/inkboxImages/sparkle.jpeg'),
    Creation('observatory bag', 'with preworn','images/cardImages/wardrobe/wardrobeSpaceBag.jpg'),
    Creation('embroidered sun top', 'with preworn','images/cardImages/wardrobe/sunEmbroidery.jpg'),
                ...
                Card(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                          ...
                          leading: Icon(Icons.star, color: apheriaamber),
                          trailing:
                    ...
                    itemBuilder: (context, index) {
                      return Card(
                        ...
                        child: Row(
                          children: [
                            Container(
                                height: 100, width: 100, color: apheriapink,
                                child:Image.asset(creationList[index].image,fit: BoxFit.cover,)
                                ),
                            SizedBox(width: 6),
                            Column(
